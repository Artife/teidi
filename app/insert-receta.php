...
if(!empty($_POST["nombre"])){
	$receta_generada = crear_nueva_receta (utf8_decode($nombre), $descripcion, $kcal_por_100g, $hidratos_porc, $proteinas_porc, $grasas_porc, $peso_maximo, $peso_minimo, $lista_ingestas);
	...
	$_SESSION['mensaje'] = 'receta_creada';	
