...
//Insertamos la dieta	
$query = "INSERT INTO gx_dietas (id_usuario, id_cliente, fecha, plantilla, duracion, num_comidas, platos_comidas, comida_postre, plato_cena, cena_postre, fecha_inicio, kilocalorias_dia, grasas_diarias, proteinas_diarias, hidratos_diarios, limitar_tamano, listado_plantillas, dieta_plantilla, todo_el_array) values
('".$_SESSION["id_usuario"]."', '".$_SESSION['dd']['id_cliente']."', '".$fecha."', '".$_SESSION['dd']['plantilla']."', '".$_SESSION['dd']['duracion']."', 
...
$mensaje = '<p class="ok">La dieta fue guardada con éxito</p>';
