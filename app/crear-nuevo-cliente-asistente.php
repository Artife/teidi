...
if (!empty($_POST["dni_cliente"])){	
	...
	$id_cliente = crear_nuevo_cliente ($dni, $nombre, $apellidos, $sexo, $telefono_fijo, $telefono_movil, $direccion, $cp, $localidad, $peso, $altura, $fecha_nacimiento, $email, $comentarios, $nombre_completo, $actividad, $fecha_de_alta);
