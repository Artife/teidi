...
$pagina = 'Asistente de generación de dieta paso 3';
...
//-> Pasos del asistente pagina 2
$id_cliente		= $_POST['id_cliente']; 
$medicion		= $_POST['medicion']; 
if($medicion == 'si'){
	header('location:'.$url_app.'crear-medicion-asistente/'.$id_cliente);
}
...
<body>
    <div id="wrapper">
		...
		<!-- Buscador -->
		<form id="formulario_completo" action="<?php echo $url_app; ?>asistente-paso-4" method="post">
		<input type="hidden" name="cliente_id" value="<?php echo $cliente_id; ?>" 	>
		<div class="row"> 				
			<div class="col-lg-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<p class="text-center"><img src="<?php echo $url_app; ?>img/paso_3.png" style="width:370px;" /></p>
						<h2>Configuración de dieta </h2> 	
						...
						<div class="row">
							...
							<div class="col-md-4">								                              
								<div class="form-group"><label class="col-lg-4 control-label">Kilocalorías/día</label>
									<div class="col-lg-6">
										<input type="number" name="kilocalorias_dia" placeholder="Duración (días)" value="<?php echo round($ultimo_peso['gasto_energetico_total']); ?>" class="form-control" required>
									</div>
								</div>
								<br /><br />
