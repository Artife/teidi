...
$grupos = obtener_grupos_excluidos_x_cliente($id_cliente);
...
$historial_pesos = obtener_historial_peso_cliente ($id_cliente);

// $total_pesos = count($historial_pesos)-1;
if(!empty($historial_pesos)){
	$ultimo_registro_peso = array_pop($historial_pesos);
}
...
<body>
    <div id="wrapper">
		...
		<!-- Buscador -->
		<form action="<?php echo $url_app; ?>actualizar-cliente" method="post">	
            ...
            <div class="col-lg-12">
				<div class="ibox float-e-margins">
					<div class="ibox-content">
						...
						<span title="Evolución del peso" class="boton_grafico" data-toggle="modal" data-target=".charts-modal"><i class="fa fa-area-chart" aria-hidden="true"></i></span>	
						<br />
						<div class="row">
							<div class="col-md-6">							
								<div class="row">
									<div class="col-md-6">										
										<div class="input-group m-b"><span class="input-group-addon" style="padding-right: 47px;">DNI</span><input id="dni" type="text" placeholder="DNI" class="form-control" name="dni_cliente" value="<?php echo $cliente['dni']; ?>" required></div>
									</div>
									<div class="col-md-6">
										<div class="input-group m-b"><span class="input-group-addon">Nombre</span><input type="text" placeholder="Nombre" class="form-control" name="nombre_cliente"  value="<?php echo $cliente['nombre']; ?>"  required></div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<div class="input-group m-b"><span class="input-group-addon">Apellidos</span><input type="text" placeholder="Apellidos" class="form-control" name="apellidos_clientes"  value="<?php echo $cliente['apellidos']; ?>" required></div>
									</div>
								</div>								
								<div class="row">
									<div class="col-md-12">
										<div class="input-group m-b"><span class="input-group-addon" style="padding-right: 37px;">Email</span><input type="email" placeholder="Email" class="form-control" name="email_cliente" value="<?php echo $cliente['email']; ?>"  required></div>
									</div>
								</div>
								<br />
								<div class="row">
										...
										<div class="login-panel panel panel-default" style="margin-top:0px;">
											...
											<div class="panel-body">										
												<div class="row"> 
													...
													<div class="col-md-6">
														<input type="number" class="form-control" id="metabolismo" name="metabolismo" step="0.01" value="<?php if (!empty($ultimo_registro_peso)) { echo $ultimo_registro_peso['metabolisto_basal']; } ?>" readonly>
													</div>
												</div>
												<br />
												<div class="row">
													...
													<div class="col-md-6">
														<input type="number" id="gasto" name="gasto" class="form-control"  step="0.01" value="<?php if (!empty($ultimo_registro_peso)) { echo $ultimo_registro_peso['gasto_energetico_total']; } ?>" readonly>
													</div>
												</div>
												<br />
												<div class="row">
													...
													<div class="col-md-6">
														<input type="number" class="form-control" name="imc" id="imc" step="0.01" value="<?php if (!empty($ultimo_registro_peso)) { echo $ultimo_registro_peso['inice_masa_corporal']; } ?>" readonly>
													</div>
												</div>
											</div>
										</div>
							...
							<div class="col-md-6">		
								<div class="row">
									<div class="col-md-3">
										<div class="input-group m-b"><span class="input-group-addon">Peso</span><input id="peso" type="number" placeholder="Peso" class="form-control" name="peso" step="0.25" value="<?php echo $cliente['peso']; ?>"  required><span class="input-group-addon">kg</span></div>
									</div>
									<div class="col-md-4">
										<div class="input-group m-b"><span class="input-group-addon" style="padding-right: 32px;">Altura</span><input id="altura" type="number" placeholder="Altura" class="form-control" name="altura" step="0.25" value="<?php echo $cliente['altura']; ?>"  required><span class="input-group-addon">cm</span></div>
									</div>
									<div class="col-md-5">
										<div class="form-group" id="data_1">
											<div class="input-group date">
												<span class="input-group-addon"> Fecha de nacimiento <i class="fa fa-calendar"></i></span><input id="fecha_nacimiento" type="text" class="form-control" value="<?php echo $cliente['fecha_nacimiento']; ?>"  name="fecha_nacimiento" required>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="col-md-3">
										<div class="input-group m-b"><span class="input-group-addon">Sexo</span>
											<select id="sexo" class="input-sm form-control input-s-sm" style="padding-top:0px;" name="sexo">																						
												<option <?php if($cliente['sexo'] == 'Hombre'){ echo "selected";}else{} ?>>Hombre</option>
												<option <?php if($cliente['sexo'] == 'Mujer'){ echo "selected";}else{} ?>>Mujer</option>
											</select>
										</div>
									</div>
									<div class="col-md-9">
										<div class="input-group m-b"><span class="input-group-addon">Actividad</span>
											<select id="actividad" class="input-sm form-control input-s-sm" style="padding-top:0px;" name="actividad">													
												<option <?php if($cliente['sexo'] == 'Intensa'){ echo "selected";}else{} ?>>Intensa</option>
												<option <?php if($cliente['sexo'] == 'Moderada'){ echo "selected";}else{} ?>>Moderada</option>
												<option <?php if($cliente['sexo'] == 'Ligera'){ echo "selected";}else{} ?>>Ligera</option>
												<option <?php if($cliente['sexo'] == 'Reposo en cama'){ echo "selected";}else{} ?>>Reposo en cama</option> 
											</select>
										</div>
									</div>									
								</div>
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="ibox-content no-padding">									
									...
									<?php 
									$html2 = $cliente['recomendaciones'];
									$entities_correction2= html_entity_decode( $html2, ENT_COMPAT, 'UTF-8');
									echo $recomendaciones = html_entity_decode( $entities_correction2, ENT_COMPAT, 'UTF-8');									 
									?>
									</textarea>
								</div>		
							</div>
							<div class="col-md-6">
								...
								<div class="ibox-content no-padding">									
									...
									<?php 
									$html = $cliente['comentarios'];
									$entities_correction= html_entity_decode( $html, ENT_COMPAT, 'UTF-8');
									echo $comentarios = html_entity_decode( $entities_correction, ENT_COMPAT, 'UTF-8');									 
									?>
									</textarea>
								</div>								
							</div>
					...
					<div class="ibox-content">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="row">
									<div class="col-md-12">
										<input type="text" placeholder="Dirección" class="form-control" name="direccion" value="<?php echo $cliente['direccion']; ?>" >
									</div>
								</div>
								<br />
								<div class="row">
									<div class="col-md-3">
										<input type="text" placeholder="Localidad" class="form-control" name="localidad" value="<?php echo $cliente['localidad']; ?>" >
									</div>
									<div class="col-md-3">
										<input type="number" placeholder="C.P." class="form-control" name="cp" value="<?php echo $cliente['cp']; ?>" >
									</div>
									<div class="col-md-3">
										<input type="text" placeholder="Teléfono Fijo" class="form-control" name="telefono_fijo" value="<?php echo $cliente['telefono_fijo']; ?>" >
									</div>
									<div class="col-md-3">
										<input type="text" placeholder="Teléfono Movil" class="form-control" name="telefono_movil" value="<?php echo $cliente['telefono_movil']; ?>" >
									</div>
								</div>
								<br /><br />		
								<div class="row">
								...
								<div class="row">
									<div class="col-md-12">								
										...
										<a href="<?php echo $url_app; ?>lista-clientes" class="btn btn-w-m btn-atras">Atras</a>
		  ...
		  <div class="modal-dialog modal-lg">
			<div class="modal-content">
			   <div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Historial de peso del cliente</h4>
			  </div>    
	...
	<script>
        ...
        $(document).ready(function(){
			...
			<?php if(!empty($grupos)){ ?>
			//-> Cascada grupos
			var grupos_inicio = [<?php echo $grupo_ids; ?>];	
			var contador_grupo = (grupos_inicio.length);
			$('#grupos_alimentos option').prop('selected', false);
			for (var i=0; i<contador_grupo; i++) {						
				$('#grupos_alimentos option[value="'+grupos_inicio[i]+'"]').prop('selected', true);				
			}
			$('#grupos_alimentos').bootstrapDualListbox('refresh', true);
			
			//-> Cascada alimentos
			var seleccion_inicio = [<?php echo $grupo_ids; ?>];						
			var contador_incio = (seleccion_inicio.length);
			$('#alimentos option').prop('selected', false);
			for (var i=0; i<contador_incio; i++) {						
				$('#alimentos option[class="'+seleccion_inicio[i]+'"]').prop('selected', true);
				$('.'+seleccion_inicio[i]).addClass('no_mover');				
			}
			$('#alimentos').bootstrapDualListbox('refresh', true);
			$('.bootstrap-duallistbox-container .removeall').prop('disabled', true);
			<?php } ?>
			
			//Calcular Titulo y edad del historial de peso
			//Calcular metabolismo
				var mostrar_edad = parseInt(calcular_edad($("#fecha_nacimiento").val()));
				if (sexo == 'Hombre')
				{
		...
		$('#grupos_alimentos').change(function() {
			...
			$('#alimentos option').prop('selected', false);
			$('#alimentos option').removeClass("no_mover");
			$('#alimentos').bootstrapDualListbox('refresh', true);
